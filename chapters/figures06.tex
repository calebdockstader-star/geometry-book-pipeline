...
\begin{tikzpicture}[scale=1.170]
 \foreach \dx/\ax/\ay in {0/0.860/1.229, 2.62/0/1.320, 5.24/-0.532/1.317}{
  \begin{scope}[xshift=\dx cm]
...
\begin{tikzpicture}[scale=0.885]
  ...
  \coordinate (Lb) at (2.90,0);
  \coordinate (B)  at (5.10,0);
  \draw[given] (Lb) -- (B);
...
\begin{tikzpicture}[scale=0.885]
  ...
  \coordinate (Lb) at (2.95,-0.32);
  \coordinate (B)  at (5.20,-0.50);
  \draw[given] (Lb) -- (B);
...
\begin{tikzpicture}[scale=0.878]
  ...
  \draw[given] (A) -- (Sa);
  \node[vlab, below right] at (A) {$A$};
  \coordinate (Lb) at (3.10,0);
  \coordinate (B)  at (5.30,0);
  \draw[given] (Lb) -- (B);
