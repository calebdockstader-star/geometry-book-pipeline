...
\tikzset{
  vlab/.append style={outer sep=4.6pt},
  slab/.append style={outer sep=4.4pt},
  klab/.append style={outer sep=4.4pt},
}
...
\begin{tikzpicture}[scale=1.10]
  ...
  \coordinate (O) at ($(F)!0.593!(E)$);    % on FE, so AO = OD and BO = OC
  ...
  % and OD, which is exactly where the book sets the letter.
  \node[vlab, above right, inner sep=1pt] at (O) {$O$};
\end{tikzpicture}
\figcap{6--41}
\end{minipage}\hfill
\begin{minipage}{0.50\linewidth}\centering
...
\begin{tikzpicture}[scale=0.95]
  ...
  \begin{scope}[xshift=3.65cm]
   ...
   \node[vlab, above left]  at (Ap) {$A\VIpr$};
...
\begin{tikzpicture}[scale=1.15]
  \coordinate (A) at (0,0);
  \coordinate (B) at (3.22,0);
  \coordinate (C) at (1.61,1.82);
  \coordinate (H) at ($(A)!0.5!(B)$);
  \coordinate (D) at ($(A)!0.66!(C)$);
  ...
  \node[vlab, above left]  at (D) {$D$};
  \node[vlab, above right] at (E) {$E$};
  \node[vlab] at ($(F)+(225:0.44)$) {$F$};
  \node[vlab] at ($(G)+(240:0.46)$) {$G$};
...
\begin{tikzpicture}[scale=0.85]
  ...
  % point -- the only quadrant at D that no stroke crosses.
  \node[vlab, above right, inner sep=1pt] at (D) {$D$};
  \node[vlab, below] at (E) {$E$};
...
\begin{tikzpicture}[scale=1.24]
  ...
  \VIarc{B}{A}{E}{0.52cm}   \VInumb{B}{A}{E}{1.00cm}{1}
  \VIarc{D}{A}{C}{0.52cm}   \VInumb{D}{A}{C}{0.90cm}{2}
...
\begin{tikzpicture}[scale=0.86]
  ...
  \begin{scope}
   ...
   \fill (O) circle (1.0pt); \fill (B) circle (1.0pt);
