...
\begin{tikzpicture}[scale=0.78]
  ...
  \foreach \p in {P1,Q1,Q2,P2,P3,Q3} \fill (\p) circle (1.4pt);
\end{tikzpicture}
\figcap{15--3}
\end{bkfigure}}
...
\begin{tikzpicture}[scale=0.44]
  ...
  \foreach \p in {(-3,0),(0,2),(3,4)} \fill \p circle (2.2pt);
\end{tikzpicture}
\figcap{15--8}
\end{minipage}\hfill
\begin{minipage}{0.48\linewidth}\centering
...
\begin{tikzpicture}[scale=0.55]
  ...
  \draw[fig] (P2) -- (F2);
  \draw[aux] (O) -- (P2);
  \foreach \p in {O,P1,P2} \fill (\p) circle (1.4pt);
...
\begin{tikzpicture}[scale=0.60]
  ...
  \draw[fig] (P3) -- (F3);
  \draw[fig] (P1) -- (P3);
  \foreach \p in {P1,P2,P3} \fill (\p) circle (1.4pt);
...
\begin{tikzpicture}[scale=0.52]
  ...
  \fill (-2,3) circle (2.0pt);
  \fill (1,5)  circle (2.0pt);
  \XVzero
...
\begin{tikzpicture}[scale=0.52]
  ...
  \fill (-1,-1.5) circle (2.2pt); \fill (2,-1.5) circle (2.2pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \draw[aux] (P1) -- (Q);
  \draw[aux] (Q)  -- (P2);
  \foreach \p in {P1,P2,Q} \fill (\p) circle (1.5pt);
...
\begin{tikzpicture}[scale=0.72]
  ...
  \draw[aux] (M) -- (Mh);
  \draw[aux] (M) -- (Mv);
  \foreach \p in {P1,P2,M} \fill (\p) circle (1.5pt);
...
\begin{tikzpicture}[scale=0.72]
  ...
  \draw[aux] (M1) -- (M2);
  \foreach \p in {M1,M2} \fill (\p) circle (1.3pt);
