...
% Label clearance, chapter-local (2026-08-17).  This chapter is nothing but
% points-on-a-line with their labels set directly over the point.  The pass
% that tightened the global `outer sep' to 2.2pt also made every point dot a
% fixed 3.2pt node, and a 3.2pt dot reaches 1.6pt out of its point -- so at
% 2.2pt the label box lands on the dot it is labelling.  check_labels shows
% the cliff exactly at the dot's diameter: 43 collisions at 2.2pt, 0 at
% 3.2pt.  Tightest clearance that clears the new dots; still tighter than
% the 3.4pt this book used before the dots existed.
