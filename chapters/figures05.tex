...
\begin{tikzpicture}[x=1.75cm,y=1cm]
  ...
  \fill (0.52,-0.61) circle (1.5pt); \fill (1.52,-0.61) circle (1.5pt);
...
\begin{tikzpicture}[x=1.75cm,y=1cm]
  \draw[given] (0,0) -- (4.40,0);
  \foreach \x in {0,1,2,3,3.18,4}{\fill (\x,0) circle (1.5pt);}
...
\begin{tikzpicture}[x=7.5cm,y=1cm]
  \draw[given] (0,0) -- (1,0);
...
\begin{tikzpicture}[x=1.9cm,y=1cm]
  ...
  \fill (2.64,0) circle (1.5pt); \fill (3.64,0) circle (1.5pt);
...
\begin{tikzpicture}[x=4.6cm,y=1cm]
  \draw[given] (0,0.80) -- (1,0.80);
  \fill (0,0.80) circle (1.5pt); \fill (1,0.80) circle (1.5pt);
...
\begin{tikzpicture}[x=4.6cm,y=1cm]
  ...
  \fill (0,0.75) circle (1.5pt); \fill (1,0.75) circle (1.5pt);
...
\begin{tikzpicture}[x=1.25cm,y=1cm]
  ...
  \fill (1.55,0.55) circle (1.5pt); \fill (4.55,0.55) circle (1.5pt);
  ...
  \fill (5.15,0.30) circle (1.5pt); \fill (5.65,0.30) circle (1.5pt);
