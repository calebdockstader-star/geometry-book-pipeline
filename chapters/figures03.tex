...
\begin{tikzpicture}[scale=0.62]
  ...
  \coordinate (P) at (2.0,0.22); \fill (P) circle (1.4pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \foreach \p in {A,B,C,D,E} \fill (\p) circle (1.4pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \foreach \p in {A,D,B,C} \fill (\p) circle (1.4pt);
  \node[vlab,above] at (A) {$A$}; \node[vlab,above] at (D) {$D$};
  \node[vlab,above] at (B) {$B$}; \node[vlab,above] at (C) {$C$};
\end{tikzpicture}
\figcap{3--12}
...
\begin{tikzpicture}[scale=0.62]
  ...
  \foreach \p in {P,Q,R} \fill (\p) circle (1.4pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \foreach \p in {A,B,P} \fill (\p) circle (1.4pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \coordinate (O) at (2.55,0); \fill (O) circle (1.5pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \fill (O) circle (1.4pt); \fill (A) circle (1.4pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \foreach \p in {O,A,P,Q} \fill (\p) circle (1.4pt);
  \node[vlab] at ($(O)+(298:0.55)$) {$O$}; \node[vlab,right] at (A) {$A$};
  \node[vlab,below] at (Q) {$Q$}; \node[vlab,below] at (P) {$P$};
\end{tikzpicture}
\figcap{3--21}
...
\begin{tikzpicture}[scale=0.62]
  ...
  \fill (O) circle (1.4pt); \fill (P) circle (1.4pt);
...
\begin{tikzpicture}[scale=0.60]
  ...
  \fill (O3) circle (1.3pt); \fill (A3) circle (1.3pt); \fill (B3) circle (1.3pt);
  \node[vlab,right] at (O3) {$O$}; \node[vlab,above] at (A3) {$A$};
  \node[vlab,below] at (B3) {$B$};
  % (iv) straight angle
  \draw[fig] (0.85,0.00) -- (3.35,0.00);
  \coordinate (O4) at (2.05,0.00); \fill (O4) circle (1.3pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \foreach \p in {A,B,Cc,D,O} \fill (\p) circle (1.3pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \foreach \p in {P,Q,Aa} \fill (\p) circle (1.3pt);
  \node[vlab,above] at (P) {$P$}; \node[vlab,above] at (Q) {$Q$};
...
\begin{tikzpicture}[scale=0.62]
  ...
  \foreach \p in {O,P,S,R} \fill (\p) circle (1.3pt);
  ...
  \foreach \p in {Qa,Qb,Qc,Qd,Qe} \fill (\p) circle (1.3pt);
...
\begin{tikzpicture}[scale=0.62]
  ...
  \draw[fig] (P) -- (Q);
  \fill (P) circle (1.3pt); \fill (Q) circle (1.3pt);
  \node[vlab,above] at (B) {$B$}; \node[vlab,left] at (A) {$A$};
  \node[vlab,right] at (C) {$C$};
...
\begin{tikzpicture}[scale=0.62]
  ...
  \fill (O) circle (1.3pt); \fill (A) circle (1.3pt); \fill (B) circle (1.3pt);
...
\begin{tikzpicture}[scale=0.58]
  ...
  \foreach \p in {P,Q,R} \fill (\p) circle (1.3pt);
